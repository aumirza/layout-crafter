...
import { MeasurementUnit, ImageFitOption, CollageCell } from "@/types/collage";
...
export function CollageSidebar({
  ...
  return (
    <Sidebar
      collapsible="none"
      className={cn(
        "h-screen border-r border-sidebar-border shrink-0 select-none z-20 transition-[width] duration-300 ease-in-out overflow-hidden",
